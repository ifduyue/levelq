...
void db_leveldb_init() {
    ...
    leveldb_options_set_cache(leveldb_options, leveldb_cache_create_lru(conf->cache_size));
    leveldb_options_set_block_size(leveldb_options, conf->block_size);
    leveldb_options_set_write_buffer_size(leveldb_options, conf->write_buffer_size);
